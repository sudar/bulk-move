...
jQuery( document ).ready(
	 ...
	 */
		...
		jQuery( 'button[value="move_tags"], button[value="move_cats"], button[value="move_category_by_tag"], button[value="move_users_by_role"], button[value="move_custom_taxonomy"]' ).click(
			function (e) {
				...
				jQuery.each(
					BULK_MOVE.validators[currentButton], function (index, validator) {
	 ...
	 */
		jQuery( '#smbm_move_custom_taxonomy_post_type' ).change(
			function () {
				...
				jQuery.post(
					ajaxurl, payload, function( response ) {
						...
						jQuery.each(
							taxonomies, function( index, taxonomy ) {
								jQuery(
									'<option/>', {
										'value': taxonomy,
										'text': taxonomy
	 ...
	 */
		jQuery( '#smbm_mbct_taxonomy' ).change(
			function () {
		...
		jQuery( '#smbm_mbct_selected_term, #smbm_mbct_mapped_term' ).change(
			function() {
