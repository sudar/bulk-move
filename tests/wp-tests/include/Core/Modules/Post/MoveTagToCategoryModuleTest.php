...
/**
 * Test BulkWP\BulkMove\Core\Modules\Post\MoveTagToCategoryModule class.
 */
class MoveTagToCategoryModuleTest extends WPCoreUnitTestCase {

	/**
	 * Variable for base move class
	 *
	 * @var \BulkWP\BulkMove\Core\Modules\Post\MoveTagToCategoryModule
	 */
	protected $tag_to_category_metabox;

	/**
	 * BaseModule move class setup
	 */
	public function setUp() {
		parent::setUp();

		$this->tag_to_category_metabox = new MoveTagToCategoryModule();
	}
