 ...
 */
class MoveRoleModuleTest extends WPCoreUnitTestCase {

	/**
	 * @var \BulkWP\BulkMove\Core\Modules\User\MoveRoleModule
	 */
	protected $module;
	...
	public function setUp() {
		...
		$this->module = new MoveRoleModule();
