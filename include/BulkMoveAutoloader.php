<?php namespace BulkWP\BulkMove;

/**
 * Autoloader for Bulk Move, based on the PSR-4 general purpose implementation.
 *
 ...
 *      $loader = new \BulkWP\BulkMove\BulkMoveAutoloader;
 *
