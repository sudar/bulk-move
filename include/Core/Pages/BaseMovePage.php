...
abstract class BaseMovePage {
	...
	/**
	 * BulkWP\BulkMove\Core\Page\BaseMovePage constructor.
	 */
	...
	public function enqueue_styles() {
		wp_register_style( 'select2', $this->get_plugin_dir_url() . 'assets/css/select2.min.css' );
		wp_enqueue_style( 'bulk-move', $this->get_plugin_dir_url() . 'assets/css/bulk-move.css', array( 'select2' ), BulkMove::VERSION );
	}
